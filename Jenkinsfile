pipeline {
    ...
    stages {
        ...
        stage('mail-notification') {
            steps {
                emailext(mimeType: 'text/html', replyTo: 'build projet', subject: "${env.JOB_NAME} - Build# ${env.BUILD_NUMBER} - ${env.BUILD_STATUS}", to: 'ibtissammdarbi@gmail.com', body: "hello world")
                /*emailext ( 
